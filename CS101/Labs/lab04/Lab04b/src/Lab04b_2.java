...
public class Lab04b_2 {
    public static void main(String[] args) {
        ...
        while (numberOfRows >= rows) {
             ...
             * since this is a reverse triangle if it has 10 lines it should print 10
             * characters in the first line of the output. So, this statement loops until
             * line no == characters that printed.
             */
